...
public class GetDownloadMasterDetailsByProjectId {
	...
	public static void getDownloadMasterDetailsByProjectId() {
		...
		Response response =
				...
				given().header("Authorization", "Bearer " + accessToken).contentType(ContentType.JSON)
						...
						.log().all()
						.get(Asha_Endpoints.downloadMasterDetailsByProjectId);
	...
	/*
	 * @DataProvider(name="credetials") String [][] getData() { String
	 * credentials[][] = {{"AshaTest23","Test12345"}}; return(credentials);
	 * 
	 * }
	 */
}
