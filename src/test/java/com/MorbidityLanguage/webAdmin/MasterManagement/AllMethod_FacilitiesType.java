...
public class AllMethod_FacilitiesType {
	...
	public static void POST_FacilitiesType () {
		...
		Response response =
				...
				.body(jsonBody)
				        .log().all()
						.post(SuperAdminEndPoints.FacilitiesType);
	...
	public static void GET_FacilitiesType() {
		Response response =
				...
				given().header("Authorization", "Bearer " + accessToken).contentType(ContentType.JSON)
						.log().all()
						.get(SuperAdminEndPoints.FacilitiesType);
	...
	public static void UPDATE_FacilitiesType() {
			...
			Response response =
					...
					.body(jsonBody)
					        .log().all()
							.put(SuperAdminEndPoints.FacilitiesType);
	...
	public static void DELETE_FacilitiesType() {
			...
			Response response =
					...
					.pathParam("morbidity_bank_id", "97")
					        .log().all()
							.delete(SuperAdminEndPoints.FacilitiesType);
